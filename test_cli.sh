...
USER_TX=$(solana program call --program-id CoUUn4AacKW8n8Cc1zZVMPP185CaRjqYEAvu4vcGC58G \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id CoUUn4AacKW8n8Cc1zZVMPP185CaRjqYEAvu4vcGC58G \
...
NFT_TX=$(solana program call --program-id CoUUn4AacKW8n8Cc1zZVMPP185CaRjqYEAvu4vcGC58G \
...
PROGRAM_DATA=$(solana account CoUUn4AacKW8n8Cc1zZVMPP185CaRjqYEAvu4vcGC58G --output json 2>/dev/null || echo "Error checking program account")
