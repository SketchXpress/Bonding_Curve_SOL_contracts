...
USER_TX=$(solana program call --program-id AvJTBKWtdp1Vr5KANbG3kW1aXnj32KekX8A7jXEwYYLT \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id AvJTBKWtdp1Vr5KANbG3kW1aXnj32KekX8A7jXEwYYLT \
...
NFT_TX=$(solana program call --program-id AvJTBKWtdp1Vr5KANbG3kW1aXnj32KekX8A7jXEwYYLT \
