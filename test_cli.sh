...
USER_TX=$(solana program call --program-id J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf \
...
NFT_TX=$(solana program call --program-id J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf \
...
PROGRAM_DATA=$(solana account J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf --output json 2>/dev/null || echo "Error checking program account")
