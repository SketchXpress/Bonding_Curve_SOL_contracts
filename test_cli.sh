...
USER_TX=$(solana program call --program-id CicL315F7cub91uKYFoCjBcVFKB267BMFXmFtDdNrvGX \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id CicL315F7cub91uKYFoCjBcVFKB267BMFXmFtDdNrvGX \
...
NFT_TX=$(solana program call --program-id CicL315F7cub91uKYFoCjBcVFKB267BMFXmFtDdNrvGX \
...
PROGRAM_DATA=$(solana account CicL315F7cub91uKYFoCjBcVFKB267BMFXmFtDdNrvGX --output json 2>/dev/null || echo "Error checking program account")
