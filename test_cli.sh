...
USER_TX=$(solana program call --program-id BW2b1MZTDYoX2BQBUqgCjZmq6brmLb4GUUcgoL4YaKro \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id BW2b1MZTDYoX2BQBUqgCjZmq6brmLb4GUUcgoL4YaKro \
...
NFT_TX=$(solana program call --program-id BW2b1MZTDYoX2BQBUqgCjZmq6brmLb4GUUcgoL4YaKro \
...
PROGRAM_DATA=$(solana account BW2b1MZTDYoX2BQBUqgCjZmq6brmLb4GUUcgoL4YaKro --output json 2>/dev/null || echo "Error checking program account")
