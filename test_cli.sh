...
USER_TX=$(solana program call --program-id 5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id 5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe \
...
NFT_TX=$(solana program call --program-id 5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe \
