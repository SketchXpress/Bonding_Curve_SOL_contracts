...
USER_TX=$(solana program call --program-id 85KVeJTCfHhLB6jfno5E41eHKBfzBxVZEADUHznnUfjG \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id 85KVeJTCfHhLB6jfno5E41eHKBfzBxVZEADUHznnUfjG \
...
NFT_TX=$(solana program call --program-id 85KVeJTCfHhLB6jfno5E41eHKBfzBxVZEADUHznnUfjG \
...
PROGRAM_DATA=$(solana account 85KVeJTCfHhLB6jfno5E41eHKBfzBxVZEADUHznnUfjG --output json 2>/dev/null || echo "Error checking program account")
