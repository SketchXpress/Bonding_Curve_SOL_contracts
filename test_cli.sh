...
USER_TX=$(solana program call --program-id FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo \
...
NFT_TX=$(solana program call --program-id FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo \
...
PROGRAM_DATA=$(solana account FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo --output json 2>/dev/null || echo "Error checking program account")
