...
USER_TX=$(solana program call --program-id CWpH1VjyMfHLMXeSjMxemHFGzgK2UFcZsBpfBPPCJiny \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id CWpH1VjyMfHLMXeSjMxemHFGzgK2UFcZsBpfBPPCJiny \
...
NFT_TX=$(solana program call --program-id CWpH1VjyMfHLMXeSjMxemHFGzgK2UFcZsBpfBPPCJiny \
...
PROGRAM_DATA=$(solana account CWpH1VjyMfHLMXeSjMxemHFGzgK2UFcZsBpfBPPCJiny --output json 2>/dev/null || echo "Error checking program account")
