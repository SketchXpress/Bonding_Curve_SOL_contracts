...
USER_TX=$(solana program call --program-id 6c3sjni7sr87CsDz3sHWHS1W7mnzSMpozAL9pwnpGsCS \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id 6c3sjni7sr87CsDz3sHWHS1W7mnzSMpozAL9pwnpGsCS \
...
NFT_TX=$(solana program call --program-id 6c3sjni7sr87CsDz3sHWHS1W7mnzSMpozAL9pwnpGsCS \
...
PROGRAM_DATA=$(solana account 6c3sjni7sr87CsDz3sHWHS1W7mnzSMpozAL9pwnpGsCS --output json 2>/dev/null || echo "Error checking program account")
