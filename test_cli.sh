...
USER_TX=$(solana program call --program-id 2z9fzHVV4x7D22JXQYyod73EYWzrNS8fq5Fdj9mwiQYo \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id 2z9fzHVV4x7D22JXQYyod73EYWzrNS8fq5Fdj9mwiQYo \
...
NFT_TX=$(solana program call --program-id 2z9fzHVV4x7D22JXQYyod73EYWzrNS8fq5Fdj9mwiQYo \
...
PROGRAM_DATA=$(solana account 2z9fzHVV4x7D22JXQYyod73EYWzrNS8fq5Fdj9mwiQYo --output json 2>/dev/null || echo "Error checking program account")
