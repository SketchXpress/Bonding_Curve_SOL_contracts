...
USER_TX=$(solana program call --program-id ACyrSsRBM98M6hb9DT8Sg5faDGJsKgNoPzcyqWqCcXg8 \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id ACyrSsRBM98M6hb9DT8Sg5faDGJsKgNoPzcyqWqCcXg8 \
...
NFT_TX=$(solana program call --program-id ACyrSsRBM98M6hb9DT8Sg5faDGJsKgNoPzcyqWqCcXg8 \
...
PROGRAM_DATA=$(solana account ACyrSsRBM98M6hb9DT8Sg5faDGJsKgNoPzcyqWqCcXg8 --output json 2>/dev/null || echo "Error checking program account")
