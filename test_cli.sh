...
USER_TX=$(solana program call --program-id AbfPoZwRvZnmDUUZjKucjyagWghGyRnCci5rG5hAwQq9 \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id AbfPoZwRvZnmDUUZjKucjyagWghGyRnCci5rG5hAwQq9 \
...
NFT_TX=$(solana program call --program-id AbfPoZwRvZnmDUUZjKucjyagWghGyRnCci5rG5hAwQq9 \
...
PROGRAM_DATA=$(solana account AbfPoZwRvZnmDUUZjKucjyagWghGyRnCci5rG5hAwQq9 --output json 2>/dev/null || echo "Error checking program account")
