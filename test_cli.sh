...
USER_TX=$(solana program call --program-id GgLTQpotYKSqmH55whQEqnCafngwxga1RzckdkpufFMU \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id GgLTQpotYKSqmH55whQEqnCafngwxga1RzckdkpufFMU \
...
NFT_TX=$(solana program call --program-id GgLTQpotYKSqmH55whQEqnCafngwxga1RzckdkpufFMU \
...
PROGRAM_DATA=$(solana account GgLTQpotYKSqmH55whQEqnCafngwxga1RzckdkpufFMU --output json 2>/dev/null || echo "Error checking program account")
