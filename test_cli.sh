...
USER_TX=$(solana program call --program-id 2sXRjvboPwnNEpNYejYQZrjpe37fMmQhVpfRqg6RvnjU \
  createUser 10 \
...
echo -e "\n=== Test 3: Create Pool ==="
echo "Creating pool..."
POOL_TX=$(solana program call --program-id 2sXRjvboPwnNEpNYejYQZrjpe37fMmQhVpfRqg6RvnjU \
...
NFT_TX=$(solana program call --program-id 2sXRjvboPwnNEpNYejYQZrjpe37fMmQhVpfRqg6RvnjU \
...
PROGRAM_DATA=$(solana account 2sXRjvboPwnNEpNYejYQZrjpe37fMmQhVpfRqg6RvnjU --output json 2>/dev/null || echo "Error checking program account")
