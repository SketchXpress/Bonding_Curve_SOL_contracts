...
USER_ACCOUNT_PDA=$(python3 derive_pda.py "user-account" $WALLET_HEX "3CJqA1HjKpsFX4ohbzEdA73ryyE5rrJjmngAmfxZJHC1")
...
if [[ $USER_ACCOUNT_INFO == *"Error"* ]]; then
  ...
  solana program call --program-id 3CJqA1HjKpsFX4ohbzEdA73ryyE5rrJjmngAmfxZJHC1 \
    createUser 10 \
...
# Derive pool PDA
POOL_PDA=$(python3 derive_pda.py "bonding-pool" $TOKEN_MINT_HEX "3CJqA1HjKpsFX4ohbzEdA73ryyE5rrJjmngAmfxZJHC1")
echo "Pool PDA: $POOL_PDA"

# Derive synthetic token mint PDA
SYNTHETIC_TOKEN_MINT_PDA=$(python3 derive_pda.py "synthetic-mint" $TOKEN_MINT_HEX "3CJqA1HjKpsFX4ohbzEdA73ryyE5rrJjmngAmfxZJHC1")
echo "Synthetic token mint PDA: $SYNTHETIC_TOKEN_MINT_PDA"

# Derive real token vault PDA
REAL_TOKEN_VAULT_PDA=$(python3 derive_pda.py "token-vault" $TOKEN_MINT_HEX "3CJqA1HjKpsFX4ohbzEdA73ryyE5rrJjmngAmfxZJHC1")
...
# Derive NFT data PDA
NFT_DATA_PDA=$(python3 derive_pda.py "nft-data" $NFT_MINT_HEX "3CJqA1HjKpsFX4ohbzEdA73ryyE5rrJjmngAmfxZJHC1")
