...
USER_ACCOUNT_PDA=$(python3 derive_pda.py "user-account" $WALLET_HEX "5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe")
...
if [[ $USER_ACCOUNT_INFO == *"Error"* ]]; then
  ...
  solana program call --program-id 5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe \
    createUser 10 \
...
# Derive pool PDA
POOL_PDA=$(python3 derive_pda.py "bonding-pool" $TOKEN_MINT_HEX "5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe")
echo "Pool PDA: $POOL_PDA"

# Derive synthetic token mint PDA
SYNTHETIC_TOKEN_MINT_PDA=$(python3 derive_pda.py "synthetic-mint" $TOKEN_MINT_HEX "5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe")
echo "Synthetic token mint PDA: $SYNTHETIC_TOKEN_MINT_PDA"

# Derive real token vault PDA
REAL_TOKEN_VAULT_PDA=$(python3 derive_pda.py "token-vault" $TOKEN_MINT_HEX "5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe")
...
# Derive NFT data PDA
NFT_DATA_PDA=$(python3 derive_pda.py "nft-data" $NFT_MINT_HEX "5a9RAcFUkirJmDBJ9R2tzEgbAPutSftpyt7he8B7FUMe")
