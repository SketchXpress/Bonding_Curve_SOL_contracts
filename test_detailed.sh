...
echo "Program ID: J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf"
echo "Network: Devnet"
...
PROGRAM_INFO=$(solana program show J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf 2>/dev/null || echo "Error verifying program")
...
USER_ACCOUNT_PDA=$(python3 derive_pda.py "user-account" $WALLET_HEX "J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf")
...
if [[ $USER_ACCOUNT_INFO == *"Error"* ]]; then
  ...
  solana program call --program-id J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf \
    createUser 10 \
...
# Derive pool PDA
POOL_PDA=$(python3 derive_pda.py "bonding-pool" $TOKEN_MINT_HEX "J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf")
echo "Pool PDA: $POOL_PDA"

# Derive synthetic token mint PDA
SYNTHETIC_TOKEN_MINT_PDA=$(python3 derive_pda.py "synthetic-mint" $TOKEN_MINT_HEX "J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf")
echo "Synthetic token mint PDA: $SYNTHETIC_TOKEN_MINT_PDA"

# Derive real token vault PDA
REAL_TOKEN_VAULT_PDA=$(python3 derive_pda.py "token-vault" $TOKEN_MINT_HEX "J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf")
...
# Derive NFT data PDA
NFT_DATA_PDA=$(python3 derive_pda.py "nft-data" $NFT_MINT_HEX "J72SyAhR7pwGfMvzSNrDTpkfmWSpNp2oqiR5hY5mWBf")
