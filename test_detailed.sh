...
echo "Program ID: FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo"
echo "Network: Devnet"
...
PROGRAM_INFO=$(solana program show FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo 2>/dev/null || echo "Error verifying program")
...
USER_ACCOUNT_PDA=$(python3 derive_pda.py "user-account" $WALLET_HEX "FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo")
...
if [[ $USER_ACCOUNT_INFO == *"Error"* ]]; then
  ...
  solana program call --program-id FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo \
    createUser 10 \
...
# Derive pool PDA
POOL_PDA=$(python3 derive_pda.py "bonding-pool" $TOKEN_MINT_HEX "FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo")
echo "Pool PDA: $POOL_PDA"

# Derive synthetic token mint PDA
SYNTHETIC_TOKEN_MINT_PDA=$(python3 derive_pda.py "synthetic-mint" $TOKEN_MINT_HEX "FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo")
echo "Synthetic token mint PDA: $SYNTHETIC_TOKEN_MINT_PDA"

# Derive real token vault PDA
REAL_TOKEN_VAULT_PDA=$(python3 derive_pda.py "token-vault" $TOKEN_MINT_HEX "FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo")
...
# Derive NFT data PDA
NFT_DATA_PDA=$(python3 derive_pda.py "nft-data" $NFT_MINT_HEX "FzwC1iKmMYjbJUMGbw5xEwQi82uKzRzN5DkUW42AHdqo")
